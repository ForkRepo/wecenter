        ...
        switch ($input_message['msgType'])
        {
            ...
            default:
                ...
                else
                {
                    ...
                    {
                        $response_message = '您的关键字: ' . $input_message['content'] . ', 目前没有文章提到过, <a href="' . $this->model('openid_weixin_weixin')->redirect_url('/m/publish/') . '">点此提问</a>';
                    }
                }
    ...
    public function message_parser($input_message, $param = null)
    {
        ...
        switch ($message_code)
        {
            default:
                ...
                else if ($search_result = $this->model('search')->search_articles($input_message['content'], null, $param, 5))
                {
